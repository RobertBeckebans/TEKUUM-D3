		...
		//GLCompileMacro_USE_DEFORM_VERTEXES(this),
{
	...
	*/
	...
	idStr vertexShaderText = BuildGPUShaderText("shadowMap", vertexInlines, GL_VERTEX_SHADER_ARB);
	idStr fragmentShaderText = BuildGPUShaderText("shadowMap", fragmentInlines, GL_FRAGMENT_SHADER_ARB);
