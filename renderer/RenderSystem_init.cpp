...
#if defined(__ANDROID__) || defined(USE_GLES1)
...
#if defined(__ANDROID__)
idCVar r_skipSpecular( "r_skipSpecular", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_CHEAT | CVAR_ARCHIVE, "use black for specular1" );
idCVar r_skipBump( "r_skipBump", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_ARCHIVE, "uses a flat surface instead of the bump map" );
#else
...
#if defined(__ANDROID__)
idCVar r_shadows( "r_shadows", "0", CVAR_RENDERER | CVAR_BOOL, "enable shadows" );
#else
...
// RB begin
idCVar r_showLightGrid( "r_showLightGrid", "1", CVAR_RENDERER | CVAR_FLOAT, "show Q3A style light grid points" );
// RB end
