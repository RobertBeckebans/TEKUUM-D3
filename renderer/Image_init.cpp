...
idCVar idImageManager::image_useNormalCompression( "image_useNormalCompression", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "1 = use dxt5 compression for normal maps" );
...
static void R_FlatNormalImage( idImage* image )
{
	...
	int red = 0; //( globalImages->image_useNormalCompression.GetInteger() == 2 ) ? 3 : 0;
	int alpha = ( red == 0 ) ? 3 : 0;
