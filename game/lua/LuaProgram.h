...
#ifndef __LUA_PROGRAM_H__
#define __LUA_PROGRAM_H__
...
Handles compiling and storage of script data.  Multiple tyLuaProgram objects
...
/*
================
tyLuaProgram::GetStatement
================
*/
/*
ID_INLINE statement_t& tyLuaProgram::GetStatement( int index )
{
...
/*
================
tyLuaProgram::GetFunction
================
*/
/*
ID_INLINE function_t* tyLuaProgram::GetFunction( int index )
{
...
/*
================
tyLuaProgram::GetFunctionIndex
================
*/
/*
ID_INLINE int tyLuaProgram::GetFunctionIndex( const function_t* func )
{
...
/*
================
tyLuaProgram::GetReturnedInteger
================
*/
ID_INLINE int tyLuaProgram::GetReturnedInteger( void )
{
	// FIXME
	return 0;
...
/*
================
tyLuaProgram::ReturnFloat
================
*/
ID_INLINE void tyLuaProgram::ReturnFloat( float value )
{
	// FIXME
...
/*
================
tyLuaProgram::ReturnInteger
================
*/
ID_INLINE void tyLuaProgram::ReturnInteger( int value )
{
	// FIXME
...
/*
================
tyLuaProgram::ReturnVector
================
*/
ID_INLINE void tyLuaProgram::ReturnVector( idVec3 const& vec )
{
	// FIXME
...
/*
================
tyLuaProgram::ReturnString
================
*/
ID_INLINE void tyLuaProgram::ReturnString( const char* string )
{
	// FIXME
...
/*
================
tyLuaProgram::GetFilename
================
*/
ID_INLINE const char* tyLuaProgram::GetFilename( int num )
{
	return fileList[ num ];
}
...
/*
================
tyLuaProgram::GetLineNumberForStatement
================
*/
/*
ID_INLINE int tyLuaProgram::GetLineNumberForStatement( int index )
{
...
/*
================
tyLuaProgram::GetFilenameForStatement
================
*/
/*
ID_INLINE const char* tyLuaProgram::GetFilenameForStatement( int index )
{
	return GetFilename( statements[ index ].file );
}
*/

#endif /* !__LUA_PROGRAM_H__ */
