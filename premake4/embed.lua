...
function EmbedGLSLFiles()
	-- load the manifest of script files
	scripts = dofile("../base/shaders/glsl/_manifest.lua")
	
	-- main script always goes at the end
	--table.insert(scripts, "_premake_main.lua")
	
	local out = io.open("renderer/GLShader_strings.h", "w+b")
	out:write("/* OpenGL GLSL shaders, as static data buffers for release mode builds */\n")
	out:write("/* DO NOT EDIT - this file is autogenerated - see BUILD.txt */\n")
	out:write("/* To regenerate this file, run: premake4 embed */ \n\n")
	out:write("typedef struct {\n")
	out:write("\tchar *name;\n");
	out:write("\tchar *shaderText;\n");
	out:write("} glslShaderDef_t;\n\n");
	out:write("static const glslShaderDef_t glsl_shaders[] = {\n")
	
	-- for i,fn in ipairs(scripts) do
		-- print(fn)			
		-- out:write("extern const char glsl_" .. fn .. "[];\n")
	-- end
	
	--local out = io.open("renderer/GLShader_strings.cpp", "w+b")
	--out:write("/* OpenGL GLSL shaders, as static data buffers for release mode builds */\n")
	--out:write("/* DO NOT EDIT - this file is autogenerated - see BUILD.txt */\n")
	--out:write("/* To regenerate this file, run: premake4 embed */ \n\n")
	--out:write("#include \"GLShader_strings.h\"\n\n")
	--out:write("const glslShaderDef_t glsl_shaders[] = {\n")
	...
	for i,fn in ipairs(scripts) do
		...
		local s = stripfile("../base/shaders/glsl/" .. fn .. ".glsl")
		writefile(out, fn, s)
...
function doembed()
	...
	-- load the manifest of script files
	--scripts = dofile("premake4/_manifest.lua")
	
	-- main script always goes at the end
	--table.insert(scripts, "_premake_main.lua")
	
	-- open scripts.c and write the file header
	-- local out = io.open("generated/scripts.c", "w+b")
